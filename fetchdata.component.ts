...
export class FetchdataComponent implements OnInit {
  public Details: object = [];  
    ...
    public Details1 = [  
        ...
        {Name:'balmy', Date: '11/17/17', Tempc: '11', Tempf: '10', summary: 'Freezing' }, 
        {Name:'balmy', Date: '11/19/17', Tempc: '20', Tempf: '10', summary: 'Chilly' },  
        {Name:'chilly', Date: '11/19/17', Tempc: '20', Tempf: '10', summary: 'Chilly' },  
        {Name:'hot', Date: '11/20/17', Tempc: '54', Tempf: '51', summary: 'Hot' }, 
        {Name:'hot', Date: '11/17/17', Tempc: '40', Tempf: '30', summary: 'Hot' }, 
        {Name:'hot', Date: '11/19/17', Tempc: '44', Tempf: '33', summary: 'Hot' }, 
        {Name:'cool', Date: '11/20/17', Tempc: '10', Tempf: '15', summary: 'cool' },  
        {Name:'Sweltering', Date: '11/19/17', Tempc: '20', Tempf: '10', summary: 'Chilly' },  
        {Name:'Sweltering', Date: '11/20/17', Tempc: '54', Tempf: '51', summary: 'Hot' }, 
        {Name:'Scorching', Date: '11/17/17', Tempc: '11', Tempf: '10', summary: 'Freezing' }, 
